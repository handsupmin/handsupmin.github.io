...
- 문장부호: 줄글(문단) 설명 문장은 마침표 사용. 한줄/개념 요약·리스트/섹션 요약은 ‘~입니다/~합니다’ 지양, 명사형 종료 또는 음슴체(마침표 금지)
...
- 제목(title): 내용/카테고리 맥락이 드러나게 구체적으로. 너무 일반적이면 카테고리+주제를 반영(예: ‘NFT의 개념’, ‘NestJS 의존성 주입 가이드’)
      - 핵심 요약(summary): 140~200자. 본문 핵심 포인트를 한 단락으로 압축(불릿 아님)
      - 본문(content): 최소 수백 자 이상, 여러 문단으로 구성
      - 마크다운 섹션 권장: 본문 섹션들(‘### 개념/배경’, ‘### 사용법/예시’, ‘### 마무리’(선택)) 후 문서 맨 아래 ‘### 요약’ 섹션 1단락 추가. 섹션 제목은 한국어로 간결하게
