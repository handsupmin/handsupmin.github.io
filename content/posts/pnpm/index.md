...
### 핵심 요약
- 프로젝트 디렉터리 단위 설치, 실제 파일은 글로벌 저장소에 보관
- node_modules는 글로벌 저장소로의 심볼릭 링크 구성
- 중복 패키지 저장 최소화로 디스크 절약 및 설치 속도 향상
- 워크스페이스로 여러 서브패키지간 의존성 공유 및 관리
...
## 간단 요약
- 프로젝트 단위로 설치되나 실제 패키지는 글로벌 저장소에 보관
- node_modules에는 글로벌 저장소로의 심볼릭 링크 생성
- 중복 저장 최소화로 디스크 절약 및 설치 속도 개선
- 워크스페이스로 서브패키지 간 의존성 공유 및 관리
